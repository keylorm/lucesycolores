 ...
 *     taxes of this type for line items; defaults to 'commerce_tax_sales_cr_type_[name]'
 ...
 */
function hook_commerce_tax_sales_cr_type_info() {
  $tax_types = array();
 ...
 *
 * @see hook_commerce_tax_sales_cr_type_info()
 */
function hook_commerce_tax_sales_cr_type_info_alter(&$tax_types) {
 ...
 *   and menu rebuild.
 *
 * @see commerce_tax_sales_cr_ui_tax_type_save()
 */
function hook_commerce_tax_sales_cr_type_insert($tax_type, $skip_reset) {
  // No example.
}
 ...
 * @see commerce_tax_sales_cr_ui_tax_type_save()
 */
function hook_commerce_tax_sales_cr_type_update($tax_type, $skip_reset) {
  // No example.
}
 ...
 *   and menu rebuild.
 *
 * @see commerce_tax_sales_cr_ui_tax_type_delete()
 */
function hook_commerce_tax_sales_cr_type_delete($tax_type, $skip_reset) {
  // No example
}
 ...
 *     'commerce_tax_sales_cr_rate_[name]'. If the tax rate name is longer than 46
 ...
 *     include anything; defaults to 'commerce_tax_sales_cr_rate_calculate'.
 */
function hook_commerce_tax_sales_cr_rate_info() {
  $tax_rates = array();
 ...
 *
 * @see hook_commerce_tax_sales_cr_rate_info()
 */
function hook_commerce_tax_sales_cr_rate_info_alter(&$tax_rates) {
 ...
 *   and menu rebuild.
 *
 * @see commerce_tax_sales_cr_ui_tax_rate_save()
 */
function hook_commerce_tax_sales_cr_rate_insert($tax_rate, $skip_reset) {
  // No example.
}
 ...
 * @see commerce_tax_sales_cr_ui_tax_rate_save()
 */
function hook_commerce_tax_sales_cr_rate_update($tax_rate, $skip_reset) {
  // No example.
}
 ...
 *   and menu rebuild.
 *
 * @see commerce_tax_sales_cr_ui_tax_rate_delete()
 */
function hook_commerce_tax_sales_cr_rate_delete($tax_rate, $skip_reset) {
  // No example.
}
 ...
 *
 * @see commerce_tax_sales_cr_type_calculate_rates()
 */
function hook_commerce_tax_sales_cr_type_calculate_rates($tax_type, $line_item) {
  // No example.
}
