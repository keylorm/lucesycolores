...
Drupal.theme.prototype.CToolsModalDialog=function(){var html="";html+='  <div id="ctools-modal">';html+='    <div class="ctools-modal-content">';html+='      <div class="modal-header">';html+='        <a class="close" href="#">';html+=Drupal.CTools.Modal.currentSettings.closeText+Drupal.CTools.Modal.currentSettings.closeImage;html+="        </a>";html+='        <span id="modal-title" class="modal-title">&nbsp;</span>';html+="      </div>";html+='      <div id="modal-content" class="modal-content">';
html+="      </div>";html+="    </div>";html+="  </div>";return html};Drupal.theme.prototype.CToolsModalThrobber=function(){var html="";html+='  <div id="modal-throbber">';html+='    <div class="modal-throbber-wrapper">';html+=Drupal.CTools.Modal.currentSettings.throbber;html+="    </div>";html+="  </div>";return html};Drupal.CTools.Modal.getSettings=function(object){var match=$(object).attr("class").match(/ctools-modal-(\S+)/);if(match)return match[1]};Drupal.CTools.Modal.clickAjaxCacheLink=function(){Drupal.CTools.Modal.show(Drupal.CTools.Modal.getSettings(this));
